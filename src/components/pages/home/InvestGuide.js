        ...
        <section className="section_guide">
            <div className="lg:w-[1260px] max-w-full mx-auto font-mont py-10">
                <div className="text-center  px-[5vw] ">
                    <h2 className="text-[32px] font-bold leading-loose py-4 text-[#151D29FF]">Investors to Understand the Risk before they Invest or Grant Unsecured Loans here</h2>
                </div>
                <div className="w-[14%] border-t-8 border-[#ffa500] mx-auto"></div>

                <div className="px-[5vw] ">
                    <ul className="px-28 py-5 list-disc">
