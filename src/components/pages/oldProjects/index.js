...
const OldProject = () => {
    ...
    const getProjects = async () => {
        try {
            await axios.get("/index.php?action=get_projects&proj_status=0").then((resp) => {
    ...
    return (
        <>
        < Helmet >
        <title>Past Projects vcrowdfund | The Future of Property Investment</title>
        </Helmet>
            ...
            <div className="">
                ...
                <div className="lg:w-[1260px] max-w-full mx-auto md:py-10 py-5">
                    <h1 className="lg:text-[40px] md:text-[30px] text-[28px] font-bold lg:py-6 py-3 text-[#151D29FF] text-center">Some Post Projects
                    </h1>
